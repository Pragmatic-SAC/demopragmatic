...
class XLSXReportController(http.Controller):
    ...
    @http.route('/xlsx_reports_kardex', type='http', auth='user', methods=['POST'], csrf=False)
    def get_report_xlsx_txt(self, model, options, output_format, token, report_name, **kw):
