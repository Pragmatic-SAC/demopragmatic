...
class XLSXReportController(http.Controller):
    ...
    @http.route('/xlsx_txt_daily_book', type='http', auth='user', methods=['POST'], csrf=False)
    def get_report_xlsx_txt_daily_book(self, model, options, output_format, token, financial_id=None, **kw):
